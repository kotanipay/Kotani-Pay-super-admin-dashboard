...
const AnaylticsBalanceChart: React.FC = () => {
  ...
  return (
    <div className="col-span-12 rounded-lg border border-stroke bg-white mt-10 px-5 pt-5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5">
...
export default AnaylticsBalanceChart;
