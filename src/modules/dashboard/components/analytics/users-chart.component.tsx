...
const UsersChart: React.FC = () => {
  ...
  return (
    <div className="col-span-12 rounded-lg border border-stroke bg-white px-5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-8">
